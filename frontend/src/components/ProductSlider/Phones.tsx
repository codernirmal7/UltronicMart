    ...
    <div className="pt-12 relative">
      ...
      {loading ? (
        ...
        <div className="py-10 relative">
          ...
          <div className="custom-swiper-button-prev2 absolute left-2 top-[50%] z-10 bg-primary/25 rounded-full w-14 h-14 p-2 cursor-pointer translate-y-[-50%]">
            <svg
          ...
          <div className="custom-swiper-button-next2 absolute right-2 top-[50%] z-10 bg-primary/25 rounded-full w-14 h-14 p-2 cursor-pointer translate-y-[-50%]">
            <svg
              viewBox="0 0 1024 1024"
              className="icon fill-primary"
              version="1.1"
