...
adminRouter.route("/product/add").post(isAdmin,upload.array("images",6),addProduct)
adminRouter.route("/product/delete").get(isAdmin,deleteProduct)

adminRouter.route("/product/update").post(isAdmin,upload.array("images",6),updateProduct)
